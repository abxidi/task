...
final class CompletedTaskPresentationTests: XCTestCase {
    ...
    func testCompletedCardsUseCompactHeightWithoutTitleStrikethrough() {
        XCTAssertEqual(CompletedTaskPresentation.cardMinimumHeight, 124)
        XCTAssertFalse(CompletedTaskPresentation.showsTitleStrikethrough)
    }
